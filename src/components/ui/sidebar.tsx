  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group/sidebar hidden md:block text-sidebar-foreground transition-all duration-200",
      ...
      >
        <div
          className={cn(
            "fixed inset-y-0 z-20 flex h-svh flex-col border-r bg-sidebar",
             state === 'collapsed' ? 'w-[var(--sidebar-width-icon)]' : 'w-[var(--sidebar-width)]',
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-4 pb-2", state === 'collapsed' && 'p-2', className)}
      {...props}
    />
  )
})
