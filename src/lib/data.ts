...
export const activities: Activity[] = [
  ...
  { id: '2', visitorName: 'Jane Smith (Amazon)', mobileNumber: '9876543211', passType: 'Delivery', status: 'Checked Out', time: '11:15 AM', date: '2023-10-27' },
  { id: '3', visitorName: 'Maintenance Team', mobileNumber: '9876543212', passType: 'Staff', status: 'Checked In', time: '09:00 AM', date: '2023-10-27' },
  { id: '4', visitorName: 'Emily White', mobileNumber: '9876543213', passType: 'Guest', status: 'Pending', time: '01:00 PM', date: '2023-10-27' },
  { id: '5', visitorName: 'UPS Delivery', mobileNumber: '9876543214', passType: 'Delivery', status: 'Checked In', time: '12:05 PM', date: '2023-10-27' },
  { id: '6', visitorName: 'Alex Green', mobileNumber: '9876543215', passType: 'Guest', status: 'Checked Out', time: '02:30 PM', date: '2023-10-26' },
  { id: '7', visitorName: 'Food Delivery', mobileNumber: '9876543216', passType: 'Delivery', status: 'Checked Out', time: '08:45 PM', date: '2023-10-26' },
